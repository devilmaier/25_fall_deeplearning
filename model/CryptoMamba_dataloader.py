...
class CryptoMambaDataset(Dataset):
    ...
    """
    def __init__(self, df, feature_cols, target_col, seq_len=240, num_nodes=30, mode='train'):
...
def get_mamba_loaders(
    ...
    """
    Function to load data for CryptoMamba model and return DataLoaders.
    ...
    Args:
        ...
        feature_list: List of feature names or path to JSON file
        target_col: Target column name (default: 'y_60m')
        seq_len: Sequence length for time series (default: 240)
        num_nodes: Number of nodes/symbols in graph (default: 30)
        batch_size: Batch size for DataLoader (default: 16)
        num_workers: Number of workers for DataLoader (default: 4)
        ban_list_path: Path to ban list JSON file (optional)
        export_path: Path to export/cache processed data (optional)
    ...
    # =====================================================================
    # 0. CACHE: Load cached data if exists
    # =====================================================================
    ...
    # =====================================================================
    # 5. EXPORT: Save full, train, val, test, and meta
    # =====================================================================
    if export_path is not None:
